                                        ...
                                        <tr>
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(function() {
                                                    $("#total_bafo, #total_harga").keyup(function() {
                                                        var harga  = $("#total_bafo").val();
                                                        var jumlah = $("#total_harga").val();
                                            ...
                                            <td>
                                                <!-- <a href="{{url('detail/'.$value->id_tender )}}">
                                                        Detail
                                                </a> -->
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal-{{$value->id_tender}}">
                                                    Open modal  
                                                </button>
                                            </td>
                                        </tr>
                                        <div class="modal" id="myModal-{{$value->id_tender}}">
