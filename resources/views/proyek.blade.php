            ...
            <div class="animated fadeIn"><div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-payment" name="cc-payment" type="date" class="form-control" aria-required="true" aria-invalid="false" value="">
                                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group"><label for="company" class=" form-control-label">Tanggal</label><input type="date" id="company" placeholder="Tanggal Surat" class="form-control"></div>
                                <div class="form-group"><label for="vat" class=" form-control-label">No Surat</label><input type="text" id="vat" placeholder="DE1234567890" class="form-control"></div>
                                <div class="form-group"><label for="street" class=" form-control-label">Harga Barang</label><input type="text" id="street" placeholder="IDR" class="form-control"></div>
                                ...
                                <div class="form-group"><label for="country" class=" form-control-label">Harga Jasa</label><input type="text" id="country" placeholder="IDR" class="form-control"></div>
                                <div class="form-group"><label for="UpProk" class=" form-control-label">Upload PROK</label><input type="file" id="file-input" name="file-input" class="form-control-file"></div>
                                <div>
                                                <!-- <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    &nbsp;
                                                    <span id="payment-button-amount">SAVE</span>
                    ...
                    <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="country" class=" form-control-label">Harga Jasa</label><input type="text" id="country" placeholder="IDR" class="form-control"></div>
                                <div class="form-group"><label for="UpProk" class=" form-control-label">Upload BAFO</label><input type="file" id="file-input" name="file-input" class="form-control-file"></div>
                                <!-- <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    &nbsp;
                                                     <span id="payment-button-amount">SAVE</span>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-number" name="cc-number" type="date" class="form-control cc-number identified visa" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
