                ...
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{ url('/vendor') }}">Input Vendor</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        <div class="card" style="width: 800px;">
                            <div class="card-header">
                                <strong class="card-title">Detail Vendor</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('tender/') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="cc-name" class="control-label mb-1">Tahun</label>
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Nama Vendor</label>
                                            ...
                                            <!-- <input type="hidden" name="uploadd_rfp" value="test">      -->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-number" name="harga_barang_keuangan" type="text" class="form-control cc-number identified visa" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Harga Jasa</label>
                                                <input id="cc-number" name="harga_jasa_keuangan" type="text" class="form-control cc-number identified visa" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Harga Barang</label>
                                                <input id="cc-number" name="harga_barang_bafo" type="text" class="form-control cc-number identified visa" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="cc-number" class="control-label mb-1">Harga Jasa</label>
                                                <input id="cc-number" name="harga_jasa_bafo" type="text" class="form-control cc-number identified visa" value="" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number">
                                                <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <!-- <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="cc-exp" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="MM / YY">
