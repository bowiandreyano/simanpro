                ...
                <ul class="nav navbar-nav">
                   ...
                   <!-- <li class="menu-title"></li> /.menu-title -->
                    <li class="menu-item-has-children dropdown active">
                        ...
                        <li><i class="fa fa-book"></i><a href="{{ url('/tender') }}">Proposal BAFO</a></li>
                        <li><i class="fa fa-th"></i><a href="{{ url('/tender') }}">Data Vendor</a></li>
                        <li><i class="fa fa-fire"></i><a href="{{ url('/tender') }}">Manage Tender</a></li>
